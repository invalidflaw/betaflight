...
// TRIFLIGHT
    { "tri_dynamic_yaw_minthrottle",   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = {    0,   500 }, PG_TRIFLIGHT_CONFIG, offsetof(triflightConfig_t, tri_dynamic_yaw_minthrottle) },
    { "tri_dynamic_yaw_maxthrottle",   VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = {    0,   100 }, PG_TRIFLIGHT_CONFIG, offsetof(triflightConfig_t, tri_dynamic_yaw_maxthrottle) },
    { "tri_dynamic_yaw_hoverthrottle", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = {    1,  2000 }, PG_TRIFLIGHT_CONFIG, offsetof(triflightConfig_t, tri_dynamic_yaw_hoverthrottle) },
